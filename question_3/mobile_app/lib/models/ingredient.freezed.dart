...
mixin _$Ingredient {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, usageAmount);

  @override
  String toString() {
    return 'Ingredient(id: $id, name: $name, usageAmount: $usageAmount)';
  }
}
...
abstract mixin class $IngredientCopyWith<$Res> {
  ...
  $Res call(
      {String id,
      String name,
      @JsonKey(name: 'usage_amount') String usageAmount});
}
...
class _Ingredient implements Ingredient {
  const _Ingredient(
      {required this.id,
      required this.name,
      @JsonKey(name: 'usage_amount') required this.usageAmount});
